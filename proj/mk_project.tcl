...
#
# Generated by Vivado on Mon Dec 16 19:10:24 +0100 2019
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/repo"] [file normalize "$origin_dir/../6502Simu/repo/ip/GPIOInterface"]" $obj
...
set obj [get_filesets sources_1]
set files [list \
 "[file normalize "$origin_dir/src/bd/GPIOTest/hdl/GPIOTest_wrapper.vhd"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/src/bd/GPIOTest/hdl/GPIOTest_wrapper.vhd"
...
set file "[file normalize "$origin_dir/src/constraints/GPIOConstraints.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "$origin_dir/src/constraints/GPIOConstraints.xdc"
set file [file normalize $file]
...
set obj [get_filesets constrs_1]
set_property -name "target_constrs_file" -value "[file normalize "$origin_dir/src/constraints/GPIOConstraints.xdc"]" -objects $obj
